...
- [0. 문제 인식](#0-문제-인식)
- [1. 조사 및 정리](#1-조사-및-정리)
  - [1) CSS를 무작정 작성했을 때 생기는 문제](#1-css를-무작정-작성했을-때-생기는-문제)
  - [2) BEM이란 무엇인가?](#2-bem이란-무엇인가)
  - [3) Tailwind CSS는 어떤 방식인가?](#3-tailwind-css는-어떤-방식인가)
  - [4) BEM vs. Tailwind CSS — 관점 비교](#4-bem-vs-tailwind-css--관점-비교)
- [2. UI 구조 설계](#2-ui-구조-설계)
- [3. 구현 (Tailwind CSS)](#3-구현-tailwind-css)
  - [HTML 시맨틱 구조](#html-시맨틱-구조)
  - [구현 도중 알게된 점](#구현-도중-알게된-점)
  - [주요 구현 결정](#주요-구현-결정)
- [4. 추가 도전](#4-추가-도전)
  - [transition / animation](#transition--animation)
  - [다크모드 스타일 적용](#다크모드-스타일-적용)
  - [카드 여러 개를 grid로 배치](#카드-여러-개를-grid로-배치)
  - [모바일/데스크탑 레이아웃 다르게 구성](#모바일데스크탑-레이아웃-다르게-구성)
- [5. 비교 및 회고](#5-비교-및-회고)
  - [1) BEM 방식으로 다시 설계](#1-bem-방식으로-다시-설계)
  - [2) Tailwind 사용 경험](#2-tailwind-사용-경험)
  - [3) BEM vs. Tailwind — 직접 비교](#3-bem-vs-tailwind--직접-비교)
  - [BEM과 Tailwind 조합](#bem과-tailwind-조합)
  - [실제 사용 조사](#실제-사용-조사)
  - [index.html을 React로 변환하면](#indexhtml을-react로-변환하면)
  - [앞으로 - 디자인 팀과의 협업](#앞으로---디자인-팀과의-협업)
